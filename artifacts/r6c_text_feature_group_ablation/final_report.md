...
Prepared: `True`.
Raw R6c panel: `artifacts/r6c_stage0_1_text_baseline_20260530/rl_stage0_1_r6c_project/artifacts/stage0_1/features/stage0_1_weight_features_raw_WITH_DEEPSEEK_V2_TEXT10.csv`.
...
| --- | --- | ---: | ---: | ---: | --- |
| R6c baseline | fold_2021 | -1.92% | -0.1015 | -11.78% | baseline |
| R6c + all raw text10 | fold_2021 | -1.61% | -0.0640 | -12.04% | useful |
...
Useful groups: R6c + all raw text10, Only risk / uncertainty, Only sentiment / price impact, Only forward-looking / earnings guidance, Only macro financial conditions, Top-3 train-correlation features.
